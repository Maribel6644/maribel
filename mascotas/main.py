...
@app.get("/")
def root():
    return {"message": "Bienvenido a la API de mascotas!"}[InternetShortcut]
URL=https://github.com/FabianOrduna/DesarrolloWebPrimavera2026/blob/main/python/mascotas/main.py
